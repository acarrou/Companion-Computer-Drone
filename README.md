...
## Drone Assembly
Below is a playlist of videos showing you on how to build your drone. This will also go over how to flash the firmware to the pixhawk. <br/> <ins>***I will go more in depth for the firmware in the next area.***</ins> You can choose either Ardupilot or PX4, however I recommend PX4 Firmware.
